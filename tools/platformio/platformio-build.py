...
FRAMEWORK_DIR = platform.get_package_dir("framework-cmsis-at32f421")
...
env.Append(
    ...
    CPPPATH=[
        join(FRAMEWORK_DIR, "libraries", "AT32F421_StdPeriph_Driver", "include"),      
        join(FRAMEWORK_DIR, "libraries", "AT32F421_board"),      
    ],
    LIBS=[
        "c",
        "m",
...
libs.append(env.BuildLibrary(
        join("$BUILD_DIR", "AT32F421_StdPeriph"), join(FRAMEWORK_DIR, "libraries", "AT32F421_StdPeriph_Driver")
    ))
libs.append(env.BuildLibrary(
        join("$BUILD_DIR", "AT32F421_board"), join(FRAMEWORK_DIR, "libraries", "AT32F421_board")
    ))
